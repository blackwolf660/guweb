...
async def login_post():
    ...
    user_info = await glob.db.fetch(
        ...
        'pw_bcrypt, silence_end, userpage_content '
        'FROM users '
        'WHERE safe_name = %s',
...
#Make badges
    ...
    user['banner'] = f"url(https://osu.risunasa.tk/banners/{user['id']});"
    ...
    #Get status
    async with glob.http.get(f"https://api.risunasa.tk/get_player_status?id={user['id']}") as resp:
